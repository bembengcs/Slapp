package com.example.slapp.util;

import android.graphics.Color;
import android.view.View;

import com.example.slapp.ui.IntroActivity;

/**
 * Created by bembengcs on 9/8/2017.
 */
    ...
    public void transformPage(final View page, final int pageIndex, final float position) {
        ...
        if (inRange(position)) {
            if (isRightPage(position)) {
                ...
                final int leftColor = IntroActivity.Content.values()[leftIndex].getColor();
                final int rightColor = IntroActivity.Content.values()[rightIndex].getColor();
                ...
                page.setBackgroundColor(IntroActivity.Content.values()[pageIndex].getColor());
            }
        } else {
            page.setBackgroundColor(IntroActivity.Content.values()[pageIndex].getColor());
        }
